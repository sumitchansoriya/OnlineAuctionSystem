      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <form action="form/cataddsql.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="catName" class="form-control form-control-lg" placeholder="Enter Category Name..." class="medium" required/>
                </div>
