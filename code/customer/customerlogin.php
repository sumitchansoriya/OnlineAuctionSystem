...
<head>
  ...
  <title>Online Auction | Customer Login</title>
  <!-- plugins:css -->
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="sellerlog.php" method="post" class="pt-3">
                <div class="form-group">
                  <input type="email" name="cemail" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" required>
                </div>
                <div class="form-group">
                ...
                <br>
                <center><p>New Customer?<a href="customerreg.php">Register Here</a></p></center>
