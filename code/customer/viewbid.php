...
$result = mysqli_query($con,"SELECT * FROM bid where cemail='$cemail' ");
          ...
          <table id="customers">
            ...
            <?php
                ...
                <td style="text-align: center">
                        <a href="form/deleteproduct.php?id=<?php echo  $row["id"]; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">Delete</a></td>
