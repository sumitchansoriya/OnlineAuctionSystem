...
if(count($_POST)>0) {
  mysqli_query($con,"UPDATE admin set id='" . $_POST['id'] . "', email='" . $_POST['email'] . "',  password='" . $_POST['password'] . "'   WHERE id='" . $_POST['id'] . "'");
...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $get_pro = "select * from admin where id='$id'";
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                ...
                <?php
                    ...
                    $classname="odd";
                    ?>
                      <h3 class="font-weight-bold">Welcome <?php echo $row["email"]; ?></h3>
